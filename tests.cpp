...
TEST_CASE("Terminal colors") {
	std::cout << std::term::info{} << "Hello World!" << std::term::reset << std::endl;
	std::cout << std::term::warning{} << "Hello World!" << std::term::reset << std::endl;
	std::cout << std::term::error{} << "Hello World!" << std::term::reset << std::endl;
	std::cout << std::term::fatal{} << "Hello World!" << std::term::reset << std::endl;
	std::cout << std::term::debug{} << "Hello World!" << std::term::reset << std::endl;
	std::cout << std::term::fg::red << "Hello World!" << std::term::reset << std::endl;
}
