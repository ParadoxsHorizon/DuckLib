...
if (DWARF_FOUND)
  if (NOT TARGET dwarf::dwarf)
    add_library (dwarf::dwarf INTERFACE IMPORTED)

    set_property (TARGET dwarf::dwarf PROPERTY
      INTERFACE_INCLUDE_DIRECTORIES ${DWARF_INCLUDE_DIR}
    )
    set_property (TARGET dwarf::dwarf PROPERTY
      INTERFACE_LINK_LIBRARIES ${DWARF_LIBRARY}
    )
    set_property (TARGET dwarf::dwarf PROPERTY
      IMPORTED_CONFIGURATIONS RELEASE
    )
  endif (NOT TARGET dwarf::dwarf)
endif (DWARF_FOUND)
