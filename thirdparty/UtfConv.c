...
Aquired from: https://stackoverflow.com/questions/36897781/how-to-uppercase-lowercase-utf-8-characters-in-c
...
// Utf 32
#ifndef IGNORE_UNNEEDED_CONVERSION_C
...
*******************************************************************************************/
inline Utf32Char* StrToUprUtf32(Utf32Char* pUtf32)
{
	Utf32Char* p = pUtf32;
	if (pUtf32 && *pUtf32) {
		while(*p) {
...
inline Utf32Char* StrToLwrUtf32(Utf32Char* pUtf32)
{
	Utf32Char* p = pUtf32;
	if (pUtf32 && *pUtf32) {
		while(*p) {
			if ((*p >= 0x41) && (*p <= 0x5a)) /* US ASCII */
				...
				case 0x018E:		//	ÆŽ	0xc6 0x8e	LATIN CAPITAL LETTER REVERSED E
					*p = 0x0258;	//	É˜	0xc9 0x98	LATIN SMALL LETTER REVERSED E
					break;
...
*******************************************************************************************/
#ifndef IGNORE_UNNEEDED_CONVERSION_C
inline size_t StrLenUtf32(const Utf32Char* str)
{
	Utf32Char* s;
	for (s = (Utf32Char*)str; *s; ++s);
	return(s - str);
}
inline Utf32Char* StrCpyUtf32(Utf32Char* dest, const Utf32Char* src)
{
	return (Utf32Char *)memcpy(dest, src, (StrLenUtf32(src) + 1)*sizeof(Utf32Char));
}
inline Utf32Char* StrCatUtf32(Utf32Char* dest, const Utf32Char* src)
{
	return StrCpyUtf32(dest + StrLenUtf32(dest), src);
}
inline int StrnCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2, size_t ztCount)
{
...
inline int StrnCiCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2, size_t ztCount)
{
...
inline int StrCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2)
{
	return StrnCmpUtf32(Utf32s1, Utf32s2, (size_t)(-1));
}
inline int StrCiCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2)
{
	return StrnCiCmpUtf32(Utf32s1, Utf32s2, (size_t)(-1));
}
inline Utf32Char* StrCiStrUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2)
{
...
*******************************************************************************************/
#ifndef IGNORE_UNNEEDED_CONVERSION_C
inline size_t StrLenUtf16(const Utf16Char* str)
{
	Utf16Char* s;
	for (s = (Utf16Char*)str; *s; ++s);
	return(s - str);
}
inline Utf16Char* StrCpyUtf16(Utf16Char* dest, const Utf16Char* src)
{
	return (Utf16Char*)memcpy(dest, src, (StrLenUtf16(src) + 1) * sizeof(Utf16Char));
}
inline Utf16Char* StrCatUtf16(Utf16Char* dest, const Utf16Char* src)
{
	return StrCpyUtf16(dest + StrLenUtf16(dest), src);
}
inline int StrnCmpUtf16(const Utf16Char* Utf16s1, const Utf16Char* Utf16s2, size_t ztCount)
{
...
inline int StrCmpUtf16(const Utf16Char* Utf16s1, const Utf16Char* Utf16s2)
{
	return StrnCmpUtf16(Utf16s1, Utf16s2, (size_t)(-1));
}
inline size_t CharLenUtf16(const Utf16Char* pUtf16)
{
	size_t ztUtf16 = 0;
...
inline Utf16Char* ForwardUtf16Chars(const Utf16Char* pUtf16, size_t ztForwardUtf16Chars)
{
	size_t ztUtf16 = 0;
	size_t ztNumUtf16Chars = 0;
...
inline size_t StrLenUtf32AsUtf16(const Utf32Char* pUtf32)
{
	size_t ztUtf32 = 0;
	size_t ztNumUtf16Chars = 0;
...
inline Utf16Char* Utf32ToUtf16(const Utf32Char* pUtf32)
{
	size_t ztUtf32 = 0;
...
inline Utf32Char* Utf16ToUtf32(const Utf16Char* pUtf16) 
{
	size_t ztUtf16 = 0;
	size_t ztUtf32 = 0;
...
inline Utf8Char* Utf16ToUtf8(const Utf16Char* pUtf16)
{
...
inline Utf16Char* Utf16StrMakeUprUtf16Str(const Utf16Char* pUtf16)
{
...
inline Utf16Char* Utf16StrMakeLwrUtf16Str(const Utf16Char* pUtf16)
{
	Utf32Char* pUtf32 = Utf16ToUtf32(pUtf16);
	if (pUtf32 && *pUtf32) {
...
inline int StrnCiCmpUtf16(const Utf16Char* pUtf16s1, const Utf16Char* pUtf16s2, size_t ztCount)
{
...
inline int StrCiCmpUtf16(const Utf16Char* pUtf16s1, const Utf16Char* pUtf16s2)
{
	return StrnCiCmpUtf16(pUtf16s1, pUtf16s2, (size_t)(-1));
}
inline Utf16Char* StrCiStrUtf16(const Utf16Char* pUtf16s1, const Utf16Char* pUtf16s2)
{
	Utf32Char* pUtf32s1 = Utf16ToUtf32(pUtf16s1);
	if (pUtf32s1) {
		Utf32Char* pUtf32s2 = Utf16ToUtf32(pUtf16s2);
...
*******************************************************************************************/
inline size_t StrLenUtf8(const Utf8Char* str)
{
	Utf8Char* s;
	for (s = (Utf8Char*)str; *s; ++s);
	return(s - str);
}
inline int StrnCmpUtf8(const Utf8Char* Utf8s1, const Utf8Char* Utf8s2, size_t ztCount)
{
...
inline int StrCmpUtf8(const Utf8Char* Utf8s1, const Utf8Char* Utf8s2)
{
	return StrnCmpUtf8(Utf8s1, Utf8s2, (size_t)(-1));
}
inline size_t CharLenUtf8(const Utf8Char* pUtf8) 
{
	size_t ztUtf8 = 0;
...
inline Utf8Char* ForwardUtf8Chars(const Utf8Char* pUtf8, size_t ztForwardUtf8Chars)
{
	size_t ztUtf8 = 0;
	size_t ztNumUtf8Chars = 0;
...
inline size_t StrLenUtf32AsUtf8(const Utf32Char* pUtf32)
{
	size_t ztUtf32 = 0;
	size_t ztNumUtf8Chars = 0;
	while (pUtf32[ztUtf32] != 0) {
...
inline Utf8Char* Utf32ToUtf8(const Utf32Char* pUtf32)
{
	size_t ztUtf32 = 0;
...
inline Utf32Char* Utf8ToUtf32(const Utf8Char* pUtf8) 
{
	size_t ztUtf8 = 0;
	size_t ztUtf32 = 0;
...
#ifndef IGNORE_UNNEEDED_CONVERSION_C
inline Utf16Char* Utf8ToUtf16(const Utf8Char* pUtf8)
{
...
#endif
inline Utf8Char* Utf8StrMakeUprUtf8Str(const Utf8Char* pUtf8)
{
...
inline Utf8Char* Utf8StrMakeLwrUtf8Str(const Utf8Char* pUtf8)
{
	Utf32Char* pUtf32 = Utf8ToUtf32(pUtf8);
	if (pUtf32 && *pUtf32) {
		StrToLwrUtf32(pUtf32);
...
#ifndef IGNORE_UNNEEDED_CONVERSION_C
inline int StrnCiCmpUtf8(const Utf8Char* pUtf8s1, const Utf8Char* pUtf8s2, size_t ztCount)
{
...
inline int StrCiCmpUtf8(const Utf8Char* pUtf8s1, const Utf8Char* pUtf8s2)
{
	return StrnCiCmpUtf8(pUtf8s1, pUtf8s2, (size_t)(-1));
}
inline Utf8Char* StrCiStrUtf8(const Utf8Char* pUtf8s1, const Utf8Char* pUtf8s2)
{
	Utf32Char* pUtf32s1 = Utf8ToUtf32(pUtf8s1);
	if (pUtf32s1) {
		Utf32Char* pUtf32s2 = Utf8ToUtf32(pUtf8s2);
...
/******************/
#include <stdio.h>
inline size_t FileWrite(char* pFileName, char* pBuffer)
{
