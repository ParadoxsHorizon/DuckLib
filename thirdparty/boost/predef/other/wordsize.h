...
#define PREDEF_OTHER_WORD_SIZE_H
...
#   define ARCH_WORD_BITS_64 VERSION_NUMBER_NOT_AVAILABLE
...
#   define ARCH_WORD_BITS_32 VERSION_NUMBER_NOT_AVAILABLE
#elif !defined(BOOST_ARCH_WORD_BITS)
