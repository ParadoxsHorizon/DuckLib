...
#define LIB_C_UC VERSION_NUMBER_NOT_AVAILABLE
...
#   define LIB_C_UC VERSION_NUMBER(\
        __UCLIBC_MAJOR__,__UCLIBC_MINOR__,__UCLIBC_SUBLEVEL__)
#endif

#if BOOST_LIB_C_UC
#   define BOOST_LIB_C_UC_AVAILABLE
#   define LIB_C_UC_AVAILABLE
#endif

#define BOOST_LIB_C_UC_NAME "uClibc"
#define LIB_C_UC_NAME "uClibc"
