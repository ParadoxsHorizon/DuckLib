...
#define PREDEF_LIBRARY_STD_MODENA_H
...
#define LIB_STD_MSIPL VERSION_NUMBER_NOT_AVAILABLE
...
#   define LIB_STD_MSIPL VERSION_NUMBER_AVAILABLE
#endif

#if BOOST_LIB_STD_MSIPL
#   define BOOST_LIB_STD_MSIPL_AVAILABLE
#   define LIB_STD_MSIPL_AVAILABLE
#endif

#define BOOST_LIB_STD_MSIPL_NAME "Modena Software Lib++"
#define LIB_STD_MSIPL_NAME "Modena Software Lib++"
