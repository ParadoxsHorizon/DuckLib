...
#define PREDEF_LIBRARY_STD_STDCPP3_H
...
#define LIB_STD_GNU VERSION_NUMBER_NOT_AVAILABLE
...
#       define LIB_STD_GNU PREDEF_MAKE_YYYYMMDD(__GLIBCXX__)
#   else
#       define BOOST_LIB_STD_GNU BOOST_PREDEF_MAKE_YYYYMMDD(__GLIBCPP__)
#       define LIB_STD_GNU PREDEF_MAKE_YYYYMMDD(__GLIBCPP__)
#   endif
#endif

#if BOOST_LIB_STD_GNU
#   define BOOST_LIB_STD_GNU_AVAILABLE
#   define LIB_STD_GNU_AVAILABLE
#endif

#define BOOST_LIB_STD_GNU_NAME "GNU"
#define LIB_STD_GNU_NAME "GNU"
