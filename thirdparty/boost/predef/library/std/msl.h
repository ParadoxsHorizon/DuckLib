...
#define PREDEF_LIBRARY_STD_MSL_H
...
#define LIB_STD_MSL VERSION_NUMBER_NOT_AVAILABLE
...
#       define LIB_STD_MSL PREDEF_MAKE_0X_VRPP(__MSL_CPP__)
#   else
#       define BOOST_LIB_STD_MSL BOOST_PREDEF_MAKE_0X_VRPP(__MSL__)
#       define LIB_STD_MSL PREDEF_MAKE_0X_VRPP(__MSL__)
#   endif
#endif

#if BOOST_LIB_STD_MSL
#   define BOOST_LIB_STD_MSL_AVAILABLE
#   define LIB_STD_MSL_AVAILABLE
#endif

#define BOOST_LIB_STD_MSL_NAME "Metrowerks"
#define LIB_STD_MSL_NAME "Metrowerks"
