...
#define PREDEF_LIBRARY_STD_SGI_H
...
#define LIB_STD_SGI VERSION_NUMBER_NOT_AVAILABLE
...
#       define LIB_STD_SGI PREDEF_MAKE_0X_VRP(__SGI_STL)
#   else
#       define BOOST_LIB_STD_SGI BOOST_VERSION_NUMBER_AVAILABLE
#       define LIB_STD_SGI VERSION_NUMBER_AVAILABLE
#   endif
#endif

#if BOOST_LIB_STD_SGI
#   define BOOST_LIB_STD_SGI_AVAILABLE
#   define LIB_STD_SGI_AVAILABLE
#endif

#define BOOST_LIB_STD_SGI_NAME "SGI"
#define LIB_STD_SGI_NAME "SGI"
