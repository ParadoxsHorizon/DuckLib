...
#define PREDEF_LIBRARY_STD_ROGUEWAVE_H
...
#define LIB_STD_RW VERSION_NUMBER_NOT_AVAILABLE
...
#           define LIB_STD_RW PREDEF_MAKE_0X_VVRRP(_RWSTD_VER)
#       else
#           define BOOST_LIB_STD_RW BOOST_PREDEF_MAKE_0X_VVRRPP(_RWSTD_VER)
#           define LIB_STD_RW PREDEF_MAKE_0X_VVRRPP(_RWSTD_VER)
#       endif
#   else
#       define BOOST_LIB_STD_RW BOOST_VERSION_NUMBER_AVAILABLE
#       define LIB_STD_RW VERSION_NUMBER_AVAILABLE
#   endif
#endif

#if BOOST_LIB_STD_RW
#   define BOOST_LIB_STD_RW_AVAILABLE
#   define LIB_STD_RW_AVAILABLE
#endif

#define BOOST_LIB_STD_RW_NAME "Roguewave"
#define LIB_STD_RW_NAME "Roguewave"
