...
#define PREDEF_LIBRARY_STD_STLPORT_H
...
#define LIB_STD_STLPORT VERSION_NUMBER_NOT_AVAILABLE

#if defined(__SGI_STL_PORT) || defined(_STLPORT_VERSION)
#   undef BOOST_LIB_STD_STLPORT
#   undef LIB_STD_STLPORT
...
#       define LIB_STD_STLPORT \
            VERSION_NUMBER(_STLPORT_MAJOR,_STLPORT_MINOR,_STLPORT_PATCHLEVEL)
#   endif
