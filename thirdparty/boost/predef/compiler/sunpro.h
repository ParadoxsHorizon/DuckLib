...
#define PREDEF_COMPILER_SUNPRO_H
...
#define COMP_SUNPRO VERSION_NUMBER_NOT_AVAILABLE
...
#           define COMP_SUNPRO_DETECTION PREDEF_MAKE_0X_VRP(__SUNPRO_CC)
#       else
#           define BOOST_COMP_SUNPRO_DETECTION BOOST_PREDEF_MAKE_0X_VVRRP(__SUNPRO_CC)
#           define COMP_SUNPRO_DETECTION PREDEF_MAKE_0X_VVRRP(__SUNPRO_CC)
#       endif
#   endif
