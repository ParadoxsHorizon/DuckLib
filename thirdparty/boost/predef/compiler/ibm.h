...
#define COMP_IBM VERSION_NUMBER_NOT_AVAILABLE
...
#       define COMP_IBM_DETECTION PREDEF_MAKE_0X_VRRPPPP(__COMPILER_VER__)
#   endif
#   if !defined(BOOST_COMP_IBM_DETECTION) && defined(__xlC__)
#       define BOOST_COMP_IBM_DETECTION BOOST_PREDEF_MAKE_0X_VVRR(__xlC__)
#       define COMP_IBM_DETECTION PREDEF_MAKE_0X_VVRR(__xlC__)
#   endif
#   if !defined(BOOST_COMP_IBM_DETECTION) && defined(__xlc__)
#       define BOOST_COMP_IBM_DETECTION BOOST_PREDEF_MAKE_0X_VVRR(__xlc__)
#       define COMP_IBM_DETECTION PREDEF_MAKE_0X_VVRR(__xlc__)
...
#       define COMP_IBM_DETECTION PREDEF_MAKE_10_VRP(__IBMCPP__)
#   endif
#endif
