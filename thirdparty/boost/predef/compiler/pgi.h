...
#define COMP_PGI VERSION_NUMBER_NOT_AVAILABLE
...
#       define COMP_PGI_DETECTION VERSION_NUMBER(__PGIC__,__PGIC_MINOR__,__PGIC_PATCHLEVEL__)
#   endif
#   if !defined(BOOST_COMP_PGI_DETECTION)
#       define BOOST_COMP_PGI_DETECTION BOOST_VERSION_NUMBER_AVAILABLE
#       define COMP_PGI_DETECTION VERSION_NUMBER_AVAILABLE
#   endif
#endif
