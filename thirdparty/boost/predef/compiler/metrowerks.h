...
#define PREDEF_COMPILER_METROWERKS_H
...
#define COMP_MWERKS VERSION_NUMBER_NOT_AVAILABLE
...
#       define COMP_MWERKS_DETECTION PREDEF_MAKE_0X_VRPP(__CWCC__)
#   endif
...
#       define COMP_MWERKS_DETECTION PREDEF_MAKE_0X_VRPP(__MWERKS__)
#   endif
...
#       define COMP_MWERKS_DETECTION VERSION_NUMBER(9,(__MWERKS__)%100-1,0)
#   endif
...
#       define COMP_MWERKS_DETECTION VERSION_NUMBER(9,(__MWERKS__)%100,0)
#   endif
...
#       define COMP_MWERKS_DETECTION VERSION_NUMBER(8,(__MWERKS__)%100,0)
#   endif
#   if !defined(BOOST_COMP_MWERKS_DETECTION)
#       define BOOST_COMP_MWERKS_DETECTION BOOST_VERSION_NUMBER_AVAILABLE
#       define COMP_MWERKS_DETECTION VERSION_NUMBER_AVAILABLE
#   endif
#endif
