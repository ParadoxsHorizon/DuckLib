...
#define COMP_GNUC VERSION_NUMBER_NOT_AVAILABLE
...
#       define COMP_GNUC_DETECTION \
            VERSION_NUMBER(__GNUC__,__GNUC_MINOR__,__GNUC_PATCHLEVEL__)
#   endif
#   if !defined(BOOST_COMP_GNUC_DETECTION)
#       define BOOST_COMP_GNUC_DETECTION \
            BOOST_VERSION_NUMBER(__GNUC__,__GNUC_MINOR__,0)
#       define COMP_GNUC_DETECTION \
            VERSION_NUMBER(__GNUC__,__GNUC_MINOR__,0)
#   endif
#endif
