...
#define PREDEF_COMPILER_COMEAU_H

#include <boost/predef/version_number.h>
#include <boost/predef/make.h>

#define BOOST_COMP_COMO BOOST_VERSION_NUMBER_NOT_AVAILABLE
#define COMP_COMO VERSION_NUMBER_NOT_AVAILABLE
...
#       define COMP_COMO_DETECTION PREDEF_MAKE_0X_VRP(__COMO_VERSION__)
#   endif
#   if !defined(BOOST_COMP_COMO_DETECTION)
#       define BOOST_COMP_COMO_DETECTION BOOST_VERSION_NUMBER_AVAILABLE
#       define COMP_COMO_DETECTION VERSION_NUMBER_AVAILABLE
#   endif
#endif
