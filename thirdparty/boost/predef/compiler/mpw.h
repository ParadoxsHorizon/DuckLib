...
#define COMP_MPW VERSION_NUMBER_NOT_AVAILABLE
...
#       define COMP_MPW_DETECTION PREDEF_MAKE_0X_VVRR(__MRC__)
#   endif
#   if !defined(BOOST_COMP_MPW_DETECTION)
#       define BOOST_COMP_MPW_DETECTION BOOST_VERSION_NUMBER_AVAILABLE
#       define COMP_MPW_DETECTION VERSION_NUMBER_AVAILABLE
#   endif
#endif
