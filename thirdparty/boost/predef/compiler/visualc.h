...
#define PREDEF_COMPILER_VISUALC_H
...
#define COMP_MSVC VERSION_NUMBER_NOT_AVAILABLE
...
#           define COMP_MSVC_BUILD (_MSC_FULL_VER % 10000)
#       elif _MSC_FULL_VER / 100000 == _MSC_VER
            /* five digits */
#           define BOOST_COMP_MSVC_BUILD (_MSC_FULL_VER % 100000)
#           define COMP_MSVC_BUILD (_MSC_FULL_VER % 100000)
#       else
...
#       define COMP_MSVC_DETECTION VERSION_NUMBER(\
            _MSC_VER/100,\
            _MSC_VER%100,\
            COMP_MSVC_BUILD)
#   elif (_MSC_VER >= 1900)
