...
#define PREDEF_COMPILER_INTEL_H
...
#define COMP_INTEL VERSION_NUMBER_NOT_AVAILABLE
...
#       define COMP_INTEL_DETECTION VERSION_NUMBER(12,1,0)
#   endif
...
#       define COMP_INTEL_DETECTION VERSION_NUMBER( \
            VERSION_NUMBER_MAJOR(PREDEF_MAKE_10_VVRR(__INTEL_COMPILER)), \
            VERSION_NUMBER_MINOR(PREDEF_MAKE_10_VVRR(__INTEL_COMPILER)), \
            __INTEL_COMPILER_UPDATE)
#   endif
...
#       define COMP_INTEL_DETECTION PREDEF_MAKE_10_VVRR(__INTEL_COMPILER)
#   endif
#   if !defined(BOOST_COMP_INTEL_DETECTION)
#       define BOOST_COMP_INTEL_DETECTION BOOST_VERSION_NUMBER_AVAILABLE
#       define COMP_INTEL_DETECTION VERSION_NUMBER_AVAILABLE
#   endif
#endif
