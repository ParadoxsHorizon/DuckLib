...
#define OS_BSD_OPEN VERSION_NUMBER_NOT_AVAILABLE
...
#       define OS_BSD VERSION_NUMBER_AVAILABLE
#       define BOOST_OS_BSD_AVAILABLE
#       define OS_BSD_AVAILABLE
#   endif
