...
#define OS_CYGWIN VERSION_NUMBER_NOT_AVAILABLE
...
#   define OS_CYGWIN \
        VERSION_NUMBER(CYGWIN_VERSION_API_MAJOR,\
                             CYGWIN_VERSION_API_MINOR, 0)
#endif

#if BOOST_OS_CYGWIN
#   define BOOST_OS_CYGWIN_AVAILABLE
#   define OS_CYGWIN_AVAILABLE
#   include <boost/predef/detail/os_detected.h>
#endif

#define BOOST_OS_CYGWIN_NAME "Cygwin"
#define OS_CYGWIN_NAME "Cygwin"
