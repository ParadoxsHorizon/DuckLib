...
#define OS_VMS VERSION_NUMBER_NOT_AVAILABLE
...
#       define OS_VMS PREDEF_MAKE_10_VVRR00PP00(__VMS_VER)
#   else
#       define BOOST_OS_VMS BOOST_VERSION_NUMBER_AVAILABLE
#       define OS_VMS VERSION_NUMBER_AVAILABLE
#   endif
#endif

#if BOOST_OS_VMS
#   define BOOST_OS_VMS_AVAILABLE
#   define OS_VMS_AVAILABLE
