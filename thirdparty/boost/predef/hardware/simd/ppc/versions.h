...
#define PREDEF_HARDWARE_SIMD_PPC_VERSIONS_H
...
#define HW_SIMD_PPC_VMX_VERSION VERSION_NUMBER(1, 0, 0)
...
#define HW_SIMD_PPC_VSX_VERSION VERSION_NUMBER(1, 1, 0)
...
#define HW_SIMD_PPC_QPX_VERSION VERSION_NUMBER(2, 0, 0)
