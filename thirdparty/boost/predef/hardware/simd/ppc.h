...
#define PREDEF_HARDWARE_SIMD_PPC_H
...
#define HW_SIMD_PPC VERSION_NUMBER_NOT_AVAILABLE
...
#   define HW_SIMD_PPC_AVAILABLE
#endif

#define BOOST_HW_SIMD_PPC_NAME "PPC SIMD"
#define HW_SIMD_PPC_NAME "PPC SIMD"
