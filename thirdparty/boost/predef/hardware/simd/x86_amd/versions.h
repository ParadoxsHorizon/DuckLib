...
#define PREDEF_HARDWARE_SIMD_X86_AMD_VERSIONS_H
...
#define HW_SIMD_X86_AMD_SSE4A_VERSION VERSION_NUMBER(4, 0, 0)
...
#define HW_SIMD_X86_AMD_FMA4_VERSION VERSION_NUMBER(5, 1, 0)
...
#define HW_SIMD_X86_AMD_XOP_VERSION VERSION_NUMBER(5, 1, 1)
