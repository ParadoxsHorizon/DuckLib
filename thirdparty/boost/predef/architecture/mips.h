...
#define PREDEF_ARCHITECTURE_MIPS_H
...
#define ARCH_MIPS VERSION_NUMBER_NOT_AVAILABLE
...
#       define ARCH_MIPS VERSION_NUMBER(2,0,0)
#   endif
...
#       define ARCH_MIPS VERSION_NUMBER(3,0,0)
#   endif
