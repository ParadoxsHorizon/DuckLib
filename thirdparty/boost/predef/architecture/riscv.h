...
#define PREDEF_ARCHITECTURE_RISCV_H
...
#define ARCH_RISCV VERSION_NUMBER_NOT_AVAILABLE

#if defined(__riscv)
#   undef BOOST_ARCH_RISCV
#   undef ARCH_RISCV
#   define BOOST_ARCH_RISCV BOOST_VERSION_NUMBER_AVAILABLE
#   define ARCH_RISCV VERSION_NUMBER_AVAILABLE
#endif

#if BOOST_ARCH_RISCV
#   define BOOST_ARCH_RISCV_AVAILABLE
#   define ARCH_RISCV_AVAILABLE
#endif
