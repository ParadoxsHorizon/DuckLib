...
#define PREDEF_ARCHITECTURE_RS6K_H
...
#define ARCH_RS6000 VERSION_NUMBER_NOT_AVAILABLE
...
#   define ARCH_RS6000 VERSION_NUMBER_AVAILABLE
#endif

#if BOOST_ARCH_RS6000
#   define BOOST_ARCH_RS6000_AVAILABLE
#   define ARCH_RS6000_AVAILABLE
#endif
...
#define ARCH_RS6000_NAME "RS/6000"

#define BOOST_ARCH_PWR BOOST_ARCH_RS6000
#define ARCH_PWR ARCH_RS6000

#if BOOST_ARCH_PWR
#   define BOOST_ARCH_PWR_AVAILABLE
#   define ARCH_PWR_AVAILABLE
#endif
...
#define ARCH_PWR_NAME ARCH_RS6000_NAME
