...
#define PREDEF_ARCHITECTURE_PTX_H
...
#define ARCH_PTX VERSION_NUMBER_NOT_AVAILABLE

#if defined(__CUDA_ARCH__)
#   undef BOOST_ARCH_PTX
#   undef ARCH_PTX
#   define BOOST_ARCH_PTX BOOST_PREDEF_MAKE_10_VR0(__CUDA_ARCH__)
#   define ARCH_PTX PREDEF_MAKE_10_VR0(__CUDA_ARCH__)
#endif

#if BOOST_ARCH_PTX
#   define BOOST_ARCH_PTX_AVAILABLE
#   define ARCH_PTX_AVAILABLE
#endif
