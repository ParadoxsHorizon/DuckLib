...
#define PREDEF_ARCHITECTURE_E2K_H
...
#define ARCH_E2K VERSION_NUMBER_NOT_AVAILABLE
...
#       define ARCH_E2K VERSION_NUMBER(__iset__,0,0)
#   endif
#   if !defined(BOOST_ARCH_E2K)
#       define BOOST_ARCH_E2K BOOST_VERSION_NUMBER_AVAILABLE
#       define ARCH_E2K VERSION_NUMBER_AVAILABLE
#   endif
#endif

#if BOOST_ARCH_E2K
#   define BOOST_ARCH_E2K_AVAILABLE
#   define ARCH_E2K_AVAILABLE
#endif
