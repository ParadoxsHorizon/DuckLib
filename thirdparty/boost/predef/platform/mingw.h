...
#define PLAT_MINGW VERSION_NUMBER_NOT_AVAILABLE
...
#       define PLAT_MINGW_DETECTION \
            VERSION_NUMBER(__MINGW64_VERSION_MAJOR,__MINGW64_VERSION_MINOR,0)
#   endif
