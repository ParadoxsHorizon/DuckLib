...
#define PLAT_IOS_DEVICE VERSION_NUMBER_NOT_AVAILABLE
#define BOOST_PLAT_IOS_SIMULATOR BOOST_VERSION_NUMBER_NOT_AVAILABLE
#define PLAT_IOS_SIMULATOR VERSION_NUMBER_NOT_AVAILABLE
...
#        undef PLAT_IOS_SIMULATOR
#        define BOOST_PLAT_IOS_SIMULATOR BOOST_VERSION_NUMBER_AVAILABLE
#        define PLAT_IOS_SIMULATOR VERSION_NUMBER_AVAILABLE
