...
#define PREDEF_PLAT_WINDOWS_UWP_H
...
#define PLAT_WINDOWS_UWP VERSION_NUMBER_NOT_AVAILABLE
#define BOOST_PLAT_WINDOWS_SDK_VERSION BOOST_VERSION_NUMBER_NOT_AVAILABLE
#define PLAT_WINDOWS_SDK_VERSION VERSION_NUMBER_NOT_AVAILABLE
...
#   undef PLAT_WINDOWS_SDK_VERSION
#   define BOOST_PLAT_WINDOWS_SDK_VERSION BOOST_VERSION_NUMBER(0, 0, VER_PRODUCTBUILD)
#   define PLAT_WINDOWS_SDK_VERSION VERSION_NUMBER(0, 0, VER_PRODUCTBUILD)
#endif
