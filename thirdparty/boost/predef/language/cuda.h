...
#define LANG_CUDA VERSION_NUMBER_NOT_AVAILABLE
...
#       define LANG_CUDA PREDEF_MAKE_10_VVRRP(CUDA_VERSION)
#   else
#       define BOOST_LANG_CUDA BOOST_VERSION_NUMBER_AVAILABLE
#       define LANG_CUDA VERSION_NUMBER_AVAILABLE
#   endif
#endif

#if BOOST_LANG_CUDA
#   define BOOST_LANG_CUDA_AVAILABLE
#   define LANG_CUDA_AVAILABLE
#endif

#define BOOST_LANG_CUDA_NAME "CUDA C/C++"
#define LANG_CUDA_NAME "CUDA C/C++"
